...
<div class="page-header">
    ...
    <div class="abc-summary-grid">
        <div class="abc-summary-card a">
            <div class="abc-class-label">A</div>
            <div class="abc-class-sub">82 items · 80% of revenue</div>
        </div>
        <div class="abc-summary-card b">
            <div class="abc-class-label">B</div>
            <div class="abc-class-sub">154 items · 15% of revenue</div>
        </div>
        <div class="abc-summary-card c">
            <div class="abc-class-label">C</div>
            <div class="abc-class-sub">312 items · 5% of revenue</div>
        </div>
    </div>
